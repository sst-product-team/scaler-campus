...
class Env {
  ...
  public static readonly dbUrl =
    process.env.DB_URL ?? "mysql://localhost:3306/scaler-campus"; // database url
  ...
  public static readonly MONGO_URI =
    process.env.MONGO_URI ?? "mongodb://localhost:27017/scaler-campus";
}
